 ...
 *
 * Compares CosmicGPT (astronomy-engine) charts against:
...
function runSeFamily(file: string, sourceLabel: string) {
  ...
  for (const c of raw.cases) {
    ...
    // Lagna: CosmicGPT uses whole-sign from AE asc; golden stores SE Placidus ASC−Lahiri
...
console.log("CosmicGPT Phase 2 cross-validation harness");
