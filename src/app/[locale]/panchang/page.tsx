      ...
      <div className="min-h-screen bg-cosmic-navy">
        ...
        <div className="container-page py-6 sm:py-8">
          ...
          <article className="mx-auto mt-10 max-w-3xl space-y-4 text-[15px] leading-relaxed text-ink-muted">
            ...
            <p>
              {hi
                ? "पंचांग का शाब्दिक अर्थ पाँच अंग है — तिथि, वार, नक्षत्र, योग और करण। ये पाँच तत्व पारंपरिक रूप से दैनिक शुभ-अशुभ समय और धार्मिक/सामाजिक कार्यों के चयन में सहायक माने जाते हैं। CosmicTalks आपके शहर के लिए सूर्योदय-अस्त के साथ इन अंगों की गणना लाहिरी पद्धति से करता है।"
                : "Panchang literally means five limbs — Tithi, Vara (weekday), Nakshatra, Yoga and Karana. Together they form the traditional daily calendar used for muhurat, festivals and everyday timing decisions. CosmicTalks calculates these limbs for your city with sunrise/sunset using the Lahiri standard."}
            </p>
            <h2 className="font-display text-xl font-bold text-ink">
