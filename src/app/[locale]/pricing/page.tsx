...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildPageMetadata({
    ...
    description: hi
      ? "CosmicTalks मूल्य: कुंडली, कैलकुलेटर और एआई चैट मुफ्त। विस्तृत परामर्श व मिलान पैकेज व्यक्तिगत सत्र में — सरल व पारदर्शी।"
      : "CosmicTalks pricing: kundli, calculators and AI chat stay free. Detailed consultation and matching packages in personal sessions — simple and transparent.",
    keywords: hi
      ? [
