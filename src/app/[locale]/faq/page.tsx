...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    ...
    description: hi
      ? "कुंडली, लग्न, नक्षत्र, दशा, एआई गुरु और ज्योतिष गणना पर 17+ स्पष्ट उत्तर — CosmicTalks FAQ पेज पर।"
      : "Clear answers on kundli, Lagna, Nakshatra, dasha, AI Guru and how charts are calculated — 17+ questions on CosmicTalks FAQ.",
    keywords: hi
      ? [
          "कुंडली FAQ",
          "ज्योतिष प्रश्न",
