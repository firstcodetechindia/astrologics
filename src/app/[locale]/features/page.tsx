...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildPageMetadata({
    ...
    description: hi
      ? "CosmicTalks पर मुफ्त जन्म कुंडली, एआई गुरु चैट, गुण मिलान, राशिफल, पंचांग, केपी, अंक ज्योतिष और 30+ कैलकुलेटर — सब एक जगह।"
      : "Explore CosmicTalks platform features: free janam kundali, AI Guru chat, gun milan, horoscope, panchang, KP, numerology and 30+ calculators in one place.",
    keywords: hi
      ? [
          "कुंडली विशेषताएँ",
          "एआई ज्योतिष",
  ...
  return (
    <div className="bg-cosmic-navy">
      ...
      <PageHero
        ...
        description={
          hi
            ? "CosmicTalks पर मुफ्त कुंडली से लेकर एआई चैट और दर्जनों कैलकुलेटर तक — एक जगह।"
            : "On CosmicTalks: free kundli, AI chat, and dozens of calculators — in one place."
        }
        crumbs={[
      ...
      <div className="container-page py-10 sm:py-12">
        ...
        <section className="mt-12 space-y-4 text-[15px] leading-relaxed text-ink-muted">
          ...
          <p>
            {hi
              ? "CosmicTalks मुफ्त जन्म कुंडली, दैनिक राशिफल, गुण मिलान, पश्चिमी/केपी/अंक ज्योतिष उपकरण और एआई गुरु चैट को एक जगह लाता है — सरल भाषा में।"
              : "CosmicTalks brings free janam kundali, daily horoscope, gun milan, Western/KP/numerology tools and AI Guru chat together — in plain English or Hindi."}
          </p>
          <p>
            {hi
