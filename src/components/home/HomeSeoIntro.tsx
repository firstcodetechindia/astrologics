    ...
    <section className="border-b border-saffron/10 bg-cosmic-navy/80">
      <div className="container-page max-w-3xl py-8 sm:py-10">
        <h2 className="font-display text-xl font-bold tracking-tight text-ink sm:text-2xl">
          {hi
            ? "CosmicGPT अलग क्यों है"
            : "Why CosmicGPT is different"}
        </h2>
        {hi ? (
          <div className="mt-4 space-y-3 text-[15px] leading-relaxed text-ink-muted">
            <p>
              CosmicGPT वैदिक कुंडली, पश्चिमी ज्योतिष, केपी ज्योतिष और अंक
            ...
            <p>
              ...
              CosmicGPT पद्धति को पारदर्शी रखता है, ताकि आप हमेशा जानें कि आप
              क्या पढ़ रहे हैं।
            </p>
          </div>
        ) : (
          <div className="mt-4 space-y-3 text-[15px] leading-relaxed text-ink-muted">
            <p>
              CosmicGPT brings together Vedic Kundli, Western astrology, KP
            ...
            <p>
              ...
              sign check or a full Kundli with dashas and yogas, CosmicGPT
