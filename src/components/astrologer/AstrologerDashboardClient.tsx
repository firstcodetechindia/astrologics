  ...
  return (
    <div className="bg-[#faf8f5]">
      <div className="container-page py-8 sm:py-10">
        <div className="mx-auto max-w-3xl overflow-hidden rounded-[1.5rem] border border-saffron/15 bg-white shadow-[0_18px_48px_-34px_rgba(42,33,24,0.45)]">
          <div className="border-b border-saffron/10 px-5 py-6 sm:px-8">
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-xl border border-saffron/25 px-3 py-2 text-xs font-semibold text-saffron-deep hover:bg-[#fff1e6]"
              >
            ...
            <section>
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {profile.skills.map((id) => (
                  <span
                    key={id}
                    className="rounded-full bg-[#fff1e6] px-3 py-1 text-[12px] font-semibold text-saffron-deep"
                  >
