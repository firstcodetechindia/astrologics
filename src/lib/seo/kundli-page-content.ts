...
export const KUNDLI_PAGE_FAQS: { q: LocaleText; a: LocaleText }[] = [
  ...
  {
    q: {
      en: "Which calculation method does Astrologics use?",
      hi: "Astrologics कौन-सी गणना पद्धति उपयोग करता है?",
    },
    a: {
  ...
  },
  {
    ...
    a: {
      en: "Yes. Chart generation on Astrologics is completely free.",
      hi: "हाँ। Astrologics पर कुंडली बनाना पूरी तरह मुफ्त है।",
    },
  },
];
