...
export const CONSULT_SESSION_FAQ: ConsultFaqItem[] = [
  {
    ...
    a: {
      en: "Every AI_PERSONA profile uses the same shared label: “AI astrologer — not a human.” It appears on the directory card, this chat window, and generated replies. Human listings are labeled “Real human astrologer.” CosmicGyan does not present AI as a person.",
      hi: "हर एआई प्रोफ़ाइल पर एक ही लेबल होता है: “एआई ज्योतिषी — मानव नहीं।” यह निर्देशिका कार्ड, इस चैट विंडो और उत्पन्न उत्तरों पर दिखता है। मानव सूची “वास्तविक मानव ज्योतिषी” कहती है। CosmicGyan एआई को व्यक्ति के रूप में नहीं दिखाता।",
    },
  },
  {
    q: {
    ...
    a: {
      en: "No. CosmicGyan consultations — human or AI — are reflective Jyotish guidance only. They are not a diagnosis, prescription, or legal opinion. For health or legal questions, speak with a qualified professional.",
      hi: "नहीं। CosmicGyan परामर्श — मानव या एआई — केवल चिंतनशील ज्योतिष मार्गदर्शन है। यह निदान, नुस्खा या कानूनी राय नहीं है। स्वास्थ्य या कानूनी प्रश्नों के लिए योग्य पेशेवर से बात करें।",
    },
  },
  {
    q: {
