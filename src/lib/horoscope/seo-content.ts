...
const PERSONALITY = [
  ...
  L(
    "Taurus (Vrishabha) builds what lasts — comfort, craft and financial grounding. Venus colours taste, loyalty and a love of beauty in daily life. Fixed earth energy — steady, patient and slow to change — prefers proven methods over sudden change. In a kundli (birth chart), strong Taurus themes often show talent for accumulation, design and patient relationships. The lesson is flexibility: not every change is a threat. When Taurus trusts gradual evolution, its stability becomes a gift to family and work alike.",
    "वृषभ टिकाऊ चीज़ें बनाता है — आराम, शिल्प और आर्थिक नींव। शुक्र रुचि, वफादारी और रोज़मर्रा की सुंदरता रंगता है। स्थिर पृथ्वी ऊर्जा (स्थिर, धैर्यवान, बदलाव में धीमी) अचानक बदलाव से ज़्यादा सिद्ध तरीकों को चुनती है। कुंडली में मज़बूत वृषभ संचय, डिज़ाइन और धैर्यपूर्ण संबंधों की प्रतिभा दिखा सकता है। पाठ है लचीलापन: हर बदलाव खतरा नहीं। जब वृषभ क्रमिक विकास पर भरोसा करता है, उसकी स्थिरता परिवार और काम दोनों के लिए वरदान बनती है।"
  ),
  L(
    "Gemini (Mithuna) lives through words, ideas and dual perspectives. Mercury sharpens curiosity, humour and the ability to connect different worlds. Dual air energy — quick-thinking and easily pulled in two directions — can multitask brilliantly, or scatter. Vedic readings often link Gemini to learning, media, commerce and sibling themes. Intelligence here is social and adaptable. Maturity arrives when Gemini chooses depth in one conversation, one skill, one promise — without losing the playful lightness that makes this sign magnetic.",
    "मिथुन शब्दों, विचारों और दोहरे दृष्टिकोण से जीता है। बुध जिज्ञासा, हास्य और अलग दुनिया जोड़ने की क्षमता तेज़ करता है। द्विस्वभाव वायु (तेज़ सोच, दो दिशाओं में खिंची) मल्टीटास्क में चमकता है — या बिखर भी सकता है। वैदिक पाठ अक्सर मिथुन को शिक्षा, मीडिया, व्यापार और सहोदर भाव से जोड़ते हैं। बुद्धिमत्ता यहाँ सामाजिक और अनुकूलनशील है। परिपक्वता तब आती है जब मिथुन एक बातचीत, एक कौशल, एक वादा गहराई से चुनता है — अपनी आकर्षक हल्की ऊर्जा खोए बिना।"
  ),
  L(
    "Cancer (Karka) protects what it loves — home, memory and emotional truth. The Moon rules mood, nurturing instincts and intuitive timing. Movable water — feelings that shift and flow easily — can move quickly between care and caution. In Vedic astrology, Cancer often highlights mother, property and the need for emotional safety before public ambition. Softness is not weakness; it is radar. Cancer thrives when feelings are named clearly and boundaries keep compassion from becoming exhaustion.",
    "कर्क जिसे प्रेम करता है उसकी रक्षा करता है — घर, स्मृति और भावनात्मक सत्य। चंद्र मूड, पालन प्रवृत्ति और सहज समय का स्वामी है। चर जल (भावनाएँ जो आसानी से बहती-बदलती हैं) देखभाल और सावधानी के बीच तेज़ी से बदल सकता है। ज्योतिष में कर्क अक्सर माता, संपत्ति और सार्वजनिक महत्वाकांक्षा से पहले भावनात्मक सुरक्षा दिखाता है। कोमलता कमज़ोरी नहीं; रडार है। जब भावनाएँ साफ़ कही जाएँ और सीमाएँ करुणा को थकान बनने से रोकें, कर्क फलता है।"
  ),
  L(
    "Leo (Simha) wants to shine with heart — creativity, dignity and generous leadership. The Sun grants vitality, pride and a need to be recognised for real contribution. Fixed fire — steady and unwavering once committed — holds loyalty to people and purposes once chosen. A strong Leo signature in the chart often shows stage presence, mentoring capacity and a protective instinct toward one’s circle. Ego softens into radiance when Leo shares the spotlight and leads through warmth rather than control.",
    "सिंह हृदय से चमकना चाहता है — रचनात्मकता, गरिमा और उदार नेतृत्व। सूर्य जीवनशक्ति, गर्व और वास्तविक योगदान के लिए मान्यता की चाह देता है। स्थिर अग्नि (एक बार चुनने पर अडिग और वफादार) उन लोगों और उद्देश्यों पर वफादार रहती है। कुंडली में मज़बूत सिंह अक्सर मंच उपस्थिति, मार्गदर्शन क्षमता और अपने दायरे की रक्षा दिखाता है। जब सिंह स्पॉटलाइट बाँटता है और नियंत्रण नहीं, गर्मजोशी से नेतृत्व करता है, अहंकार तेज में बदल जाता है।"
  ),
  L(
    "Virgo (Kanya) refines life through detail, service and intelligent systems. Mercury here turns critical thinking into practical improvement. Dual earth energy — practical, but always adjusting — notices what others miss, and can over-correct. Vedic astrology associates Virgo with health routines, skill mastery and clean process. The highest Virgo expression is helpful clarity, not endless fault-finding. When self-compassion joins precision, Virgo becomes the quiet engineer of better days.",
    "कन्या विवरण, सेवा और बुद्धिमान सिस्टम से जीवन परिष्कृत करती है। यहाँ बुध आलोचनात्मक सोच को व्यावहारिक सुधार बनाता है। द्विस्वभाव पृथ्वी (व्यावहारिक पर हमेशा ढलती) वो देखती है जो अन्य चूकते हैं — और अति-सुधार भी कर सकती है। वैदिक ज्योतिष कन्या को स्वास्थ्य दिनचर्या, कौशल और स्वच्छ प्रक्रिया से जोड़ता है। उच्चतम कन्या अभिव्यक्ति सहायक स्पष्टता है, अंतहीन दोष नहीं। जब आत्म-करुणा सटीकता से जुड़ती है, कन्या बेहतर दिनों की शांत इंजीनियर बनती है।"
  ),
  L(
    "Libra (Tula) seeks balance — in relationships, aesthetics and decisions. Venus brings charm, diplomacy and a dislike of harsh conflict. Movable air — thoughtful, weighing every angle — considers options carefully, sometimes too long. In a birth chart, Libra themes often include partnership, justice and design. Fairness is Libra’s north star. Growth comes from choosing a side when needed, without abandoning kindness. Then harmony becomes courage, not avoidance.",
    "तुला संतुलन चाहती है — संबंधों, सौंदर्य और निर्णयों में। शुक्र आकर्षण, कूटनीति और कठोर संघर्ष से दूरी लाता है। चर वायु (हर पहलू तोलने वाली, विचारशील) विकल्प तोलती है, कभी बहुत देर तक। जन्म कुंडली में तुला साझेदारी, न्याय और डिज़ाइन से जुड़ती है। निष्पक्षता तुला का ध्रुवतारा है। विकास तब है जब जरूरत पर पक्ष चुनें, दया छोड़े बिना। तब सामंजस्य बचाव नहीं, साहस बनता है।"
  ),
  L(
    "Scorpio (Vrischika) feels life at full intensity — loyalty, research and transformation. Mars (and Ketu in some classical lists) fuels focus that can heal or control. Fixed water — deep, steady and hard to shake — does not forget easily; trust is earned in private. Vedic astrology often links Scorpio to deep insight, shared resources and profound emotional honesty. Power used to protect and regenerate becomes wisdom. Power used only to win becomes a cage. Choose the first.",
    "वृश्चिक जीवन को तीव्रता से महसूस करता है — वफादारी, शोध और रूपांतरण। मंगल (कुछ परंपराओं में केतु भी) ऐसा फोकस देता है जो उपचार या नियंत्रण दोनों कर सकता है। स्थिर जल (गहरा, दृढ़, आसानी से न डिगने वाला) आसानी से नहीं भूलता; विश्वास निजी जगह में बनता है। ज्योतिष वृश्चिक को गूढ़ दृष्टि, साझा संसाधन और गहरी भावनात्मक ईमानदारी से जोड़ता है। रक्षा और पुनरुत्थान की शक्ति ज्ञान बनती है। केवल जीत की शक्ति पिंजरा। पहली चुनें।"
  ),
  L(
    "Sagittarius (Dhanu) expands toward meaning — travel, teaching and honest belief. Jupiter blesses optimism, ethics and the hunger to understand the big picture. Dual fire — enthusiastic but easily distracted — starts many journeys; maturity finishes the important ones. Vedic charts with strong Sagittarius often show mentors, publishing or cross-cultural work. Freedom is sacred here, but so is integrity. When Sagittarius aims higher without preaching, its hope becomes contagious.",
    "धनु अर्थ की ओर फैलता है — यात्रा, शिक्षण और ईमानदार विश्वास। गुरु आशावाद, नैतिकता और बड़ी तस्वीर समझने की भूख देता है। द्विस्वभाव अग्नि (उत्साही पर आसानी से भटकने वाली) कई यात्राएँ शुरू करती है; परिपक्वता महत्वपूर्ण पूरी करती है। मज़बूत धनु वाली कुंडलियाँ अक्सर गुरु, प्रकाशन या सांस्कृतिक सेतु दिखाती हैं। स्वतंत्रता पवित्र है, अखंडता भी। जब धनु उपदेश बिना ऊँचा लक्ष्य रखता है, उसकी आशा संक्रामक बनती है।"
  ),
  L(
    "Capricorn (Makara) climbs with structure — responsibility, time and earned respect. Saturn teaches delay that strengthens, not delay that defeats. Movable earth — practical and always adjusting the plan — plans in decades while still handling today’s duties. Capricorn signatures in kundli work often appear as leadership through competence. Softness is the secret upgrade: ambition without warmth isolates. Ambition with care builds legacies people actually want to inherit.",
    "मकर संरचना से चढ़ता है — ज़िम्मेदारी, समय और अर्जित सम्मान। शनि ऐसा विलंब सिखाता है जो मज़बूत करे, हराए नहीं। चर पृथ्वी (व्यावहारिक, हमेशा योजना समायोजित करने वाली) दशकों में योजना बनाती है और आज का कर्तव्य भी निभाती है। कुंडली में मकर अक्सर दक्षता से नेतृत्व दिखाता है। कोमलता गुप्त अपग्रेड है: बिना गर्मजोशी की महत्वाकांक्षा अकेला करती है। देखभाल वाली महत्वाकांक्षा ऐसी विरासत बनाती है जिसे लोग सच में अपनाना चाहें।"
  ),
  L(
    "Aquarius (Kumbha) innovates for the collective — ideas, networks and reform. Saturn (and Rahu in some modern readings) mixes discipline with disruption. Fixed air — firm ideals, independent thinking — holds convictions firmly; friendships matter as much as romance. Vedic Aquarius themes include technology, community and unconventional paths. The heart of this sign is humanitarian intelligence. Stay human while inventing the future, and Aquarius becomes a bridge, not a broadcast tower.",
    "कुम्भ सामूहिक के लिए नवाचार करता है — विचार, नेटवर्क और सुधार। शनि (कुछ आधुनिक पाठों में राहु भी) अनुशासन को विघटन से मिलाता है। स्थिर वायु (दृढ़ आदर्श, स्वतंत्र सोच) आदर्श मज़बूती से पकड़ती है; मित्रता प्रेम जितनी महत्वपूर्ण। वैदिक कुम्भ में तकनीक, समुदाय और अपरंपरागत मार्ग आते हैं। इस राशि का हृदय मानवीय बुद्धि है। भविष्य गढ़ते हुए इंसान बने रहें — कुम्भ प्रसारण टॉवर नहीं, सेतु बने।"
  ),
  L(
    "Pisces (Meena) dissolves borders — empathy, art and spiritual imagination. Jupiter softens perception into compassion and creative flow. Dual water — deeply sensitive, easily moved — feels the room before speaking. Strong Pisces in a chart may indicate healing gifts, film, music or seva (selfless service). Boundaries are not betrayal; they are how sensitivity survives. When Pisces anchors dreams in small daily acts, intuition becomes practical guidance instead of fog.",
    "मीन सीमाएँ घुलाता है — सहानुभूति, कला और आध्यात्मिक कल्पना। गुरु धारणा को करुणा और रचनात्मक प्रवाह बनाता है। द्विस्वभाव जल (गहराई से संवेदनशील, आसानी से भावुक) बोलने से पहले कमरा महसूस करता है। मज़बूत मीन उपचार, फिल्म, संगीत या सेवा का संकेत दे सकता है। सीमाएँ विश्वासघात नहीं; संवेदनशीलता कैसे बचती है। जब मीन सपनों को छोटी रोज़ क्रियाओं में बाँधता है, अंतर्ज्ञान कोहरा नहीं, व्यावहारिक मार्गदर्शन बनता है।"
  ),
];
...
function deepGuide(i: number): LocaleText[] {
  ...
  return [
    ...
    L(
      `In Vedic practice, many astrologers prefer the Moon sign (Chandra Rashi) for day-to-day guidance because the Moon reflects the mind and fluctuating mood. Your Sun sign still describes core vitality. For precision beyond any free ${n.en} horoscope, generate a full kundli (birth chart) with your birth time and place, then ask CosmicTalks AI Guru about your dasha (the planetary time-period you're currently living through), yogas (special planet combinations in your chart) and which planets rule which parts of your life — all explained in plain language, specific to you.`,
      `वैदिक परंपरा में दैनिक मार्गदर्शन हेतु अक्सर चंद्र राशि प्राथमिक है क्योंकि चंद्र मन और बदलते मूड को दर्शाता है। सूर्य राशि मूल ऊर्जा बताती है। मुफ़्त ${n.hi} राशिफल से आगे सटीकता के लिए जन्म समय-स्थान से पूर्ण कुंडली बनाएँ और CosmicTalks एआई गुरु से सरल भाषा में अपनी दशा (वर्तमान ग्रह समय-काल), योग (विशेष ग्रह संयोजन) व भावेश (कौन-सा ग्रह जीवन के किस हिस्से पर हावी है) के बारे में पूछें।`
    ),
    L(
      `Use this ${n.en} forecast as timing weather: supportive windows for action, quieter windows for repair. Pair it with today’s panchang — the Hindu daily almanac that lists the tithi (lunar date), nakshatra (Moon's star position) and yoga (a planetary combination) — when choosing an auspicious time for travel, contracts or family rituals. That combination — sign horoscope + panchang + personal chart — is how intelligent astrology stays useful without fear-mongering.`,
      `इस ${n.hi} पूर्वानुमान को समय के मौसम की तरह लें: क्रिया के सहायक पल, मरम्मत के शांत पल। यात्रा, अनुबंध या पारिवारिक अनुष्ठान हेतु शुभ समय चुनते वक्त आज के पंचांग (तिथि, नक्षत्र, योग) से जोड़ें। राशिफल + पंचांग + व्यक्तिगत कुंडली — यही बुद्धिमान ज्योतिष है, भय के बिना।`
    ),
  ];
}
...
function aiInsight(i: number): LocaleText {
  ...
  const r = SIGN_LORDS[i];
  return L(
    `AI Guru tip for ${n.en}: think of ${r.en} as this sign's "home planet" — track how it's placed in your personal birth chart and how it's currently moving through the sky. A general ${n.en} horoscope describes the sign's overall weather; your personal kundli shows exactly which part of your life that weather is affecting — career, marriage, health or wealth. Ask AI Guru with your birth details for an answer grounded in your own chart, not a generic one.`,
    `${n.hi} के लिए एआई गुरु सुझाव: ${r.hi} को इस राशि का "मुख्य ग्रह" मानें — देखें कि यह आपकी निजी कुंडली में कहाँ बैठा है और अभी आकाश में कैसे गति कर रहा है। सामान्य ${n.hi} राशिफल राशि का समग्र मौसम बताता है; आपकी निजी कुंडली बताती है वह मौसम ठीक-ठीक जीवन के किस हिस्से पर असर डाल रहा है — करियर, विवाह, स्वास्थ्य या धन। जन्म विवरण देकर एआई गुरु से अपनी ही कुंडली पर आधारित उत्तर लें, सामान्य नहीं।`
  );
}
