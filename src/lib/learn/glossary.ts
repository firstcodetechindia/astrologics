...
export function glossaryTermArticle(
  ...
  if (hi) {
    return [
      ...
      `CosmicGPT पर मुफ्त जन्म कुंडली और कैलकुलेटर लाहिरी निरयण पद्धति का उपयोग करते हैं। ${term} की व्याख्या भी उसी परंपरा के संदर्भ में दी गई है।`,
  ...
  return [
    ...
    `CosmicGPT free janam kundli and calculators use the Lahiri (Chitrapaksha) sidereal framework. Mentions of ${term} on this site stay aligned with that practical Jyotish context.`,
