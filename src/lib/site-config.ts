/** Live production fallback until NEXT_PUBLIC_SITE_URL points at the new domain. */
...
export const siteConfig = {
  brandName: process.env.NEXT_PUBLIC_BRAND_NAME || "CosmicGyan",
...
export function whatsappLink(message?: string) {
  const text = encodeURIComponent(
    message ||
      "Namaste, I found CosmicGyan and would like a detailed kundli reading and guidance."
  );
